 ...
 * @LastEditTime: 2022-11-07 11:05:35
...
const getHref = async (url) => {
    ...
    const science = {
        ...
        time: $('body > div.page-en > div.meetingHead > div > div.meetingHead-content-name.pb36 > div:nth-child(3) > span').text().replace(/\s+/g,""),//去掉所有空格
        // time: $('body > div.page-en > div.meetingHead > div > div.meetingHead-content-name.pb36 > div:nth-child(3) > span').text().replace(/[\r\n]/g, ""),//去掉换行
        content: $('body > div.page-en > div.pt36.mb70 > div > div.rich-bg').text().replace(/\s+/g,""),  //会议议程存在问题，改为content
    }
    console.log(science);
    //存入数据库
    connection.query('INSERT INTO hah SET ?', science, function (error, results, fields) {
